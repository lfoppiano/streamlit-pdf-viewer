 ...
 */
import { Table, Vector, StructRow } from "apache-arrow";
export type CellType = "blank" | "index" | "columns" | "data";
/** Data types used by ArrowJS. */
export type DataType = null | boolean | number | string | Date | Int32Array | Uint8Array | Vector | StructRow;
...
export declare class ArrowTable {
    ...
    getContent: (table: Table, rowIndex: number, columnIndex: number) => DataType;
    /**
